...
public class TestAssignmentRefactorProcessMethod {
    ...
    // I actually think that it's not only fine, but straight up better to use "magical strings"
    // (not magical numbers though)
    // ofc if the string is self-describing, like in templates for log messages.
